...
- (NSColor *)colorByIndex:(NSInteger)index {
	...
	switch (index) {
		...
		default:
            if(index<255)
            {
                color = [NSColor colorWithDeviceRed:index/255.0 green:204/255.0 blue:204/255.0 alpha:1.0];
            }
            else if(index<510)
            {
                color = [NSColor colorWithDeviceRed:204/255.0 green:(index/2)/255.0 blue:204/255.0 alpha:1.0];
            }
            else if(index<765)
            {
                color = [NSColor colorWithDeviceRed:index/255.0 green:204/255.0 blue:(index/3)/255.0 alpha:1.0];
            }
