...
//	[[self windowForSheet] setContentBorderThickness:24.0 forEdge:NSMinYEdge];
    ...
    [ActiveRecordHelpers setupCoreDataStackWithAutoMigratingSqliteStoreNamed:@"neotest.sqlite"];
    
    
    //Magicall record related stuff
    Device *d = [Device createEntity];
    NSArray *test = [Device findAll];
